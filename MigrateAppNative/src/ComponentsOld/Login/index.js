...
import {
  StyleSheet, Text, View, TextInput, TouchableHighlight, Dimensions, ScrollView, Image, Modal, Alert
} from 'react-native';
import { Button } from 'react-native-material-ui';
import {
  Container, Header, Content, Item, Input, Icon, CardItem
} from 'native-base';
        ...
        return (
          <ScrollView>
            ...
            >
              ...
              <View style={{
                height: 290, alignItems: 'center', justifyContent: 'center', padding: 3
              }}
              >
                <View style={{
                  padding: 15
              ...
              <View style={{
                display: 'flex', flexDirection: 'row', height: 150, backgroundColor: '#0F385A', padding: 15, textAlign: 'center'
              }}
              >
                <View style={{ flex: 1 }}>
